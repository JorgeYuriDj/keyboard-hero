...
function StatCell({
  ...
  return (
    <div className="bg-[#0f0d1a] rounded-xl p-3 text-center border border-purple-800/20">
...
export default function ResultScreen({
  ...
  // Calculate XP earned (simple formula based on score)
  const xpEarned = Math.round(result.score * 2 + result.stars * 50);
  ...
  return (
    <div className="min-h-screen bg-[#0f0d1a] flex flex-col items-center px-4 py-8 relative">
      {/* Lesson Title */}
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-gray-400 text-sm">Pontuacao</p>
      </div>
      ...
      <div className="w-full max-w-lg mb-8">
        <div className="bg-gradient-to-br from-purple-700 to-purple-900 rounded-2xl p-5 border border-purple-600/30 shadow-lg shadow-purple-900/30">
          ...
          {isLoadingFeedback ? (
            ...
            <p className="text-purple-200 text-sm italic">
              Feedback indisponivel no momento.
            </p>
          )}
        </div>
      </div>
      ...
      <button
        onClick={onHome}
        className="mt-3 text-gray-500 hover:text-gray-300 text-sm transition-all duration-300"
      >
        Voltar ao inicio
      </button>
